              ...
              <div className="flex flex-col items-center text-center">
                {isDoc ? (
                  <>
                    ...
                    <Link
                      href="/about"
                      className="w-[175px] mt-4 px-4 py-2 text-sm font-medium bg-[#7098C0] hover:bg-[#5a7fa6] rounded transition"
                    >
                      Online Documentation
                    </Link>
                  </>
                  ...
                  <>
                    ...
                    <Link
                      href="/contact-us"
                      className="w-fit mt-4 px-4 py-2 text-sm font-medium bg-[#B55527] hover:bg-[#9e461f] rounded transition"
                    >
                      Get Support
                    </Link>
