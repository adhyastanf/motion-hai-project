      ...
      <div className="relative z-20">
        ...
        >
          {projects.map((project, idx) => (
            <SwiperSlide
              key={idx}
              style={{ width: "320px", borderRadius: "1rem", cursor: "pointer" }}
        ...
        <AnimatePresence>
          {selectedProject && (
            <motion.div
              className="fixed inset-0 flex items-center justify-center bg-black/70 z-[100] p-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              >
                <button
                  className="absolute top-4 right-5 text-white text-2xl hover:text-red-400 z-30"
                  onClick={() => setSelectedProject(null)}
                >
                  &times;
                </button>

                <h2 className="text-white text-xl sm:text-2xl md:text-3xl font-semibold mb-4 text-center">
                ...
                {selectedProject.videoId ? (
                  ...
                  <Image
                    ...
                    className="w-full max-h-[400px] object-contain mx-auto rounded-lg border border-gray-300"
                    unoptimized
                  />
                )}
                ...
                <div className="mt-6 flex justify-center gap-6">
                  <button
                    className="text-gray-400 hover:text-gray-200 text-sm font-medium transition-colors pointer-events-auto"
